...
public interface DocumentService {
         ...
         */
        List<Documente> cautaNumeTipDocument(String tipoDocumento);
         ...
         *
         */
        List<Documente> cautareDocumentCriteria(int first, int pageSize, String sortField, SortOrder sortOrder,
         ...
         * @return Documente documentul încărcat în baza de date
         * @throws GesintException Excepție posibilă
         *
         */

        Documente cargaDocumento(UploadedFile file, TipDocument tipo, Utilizator usuario) throws GesintException;
         ...
         * @throws GesintException Excepție posibilă
         */
        Documente incarcareDocumentFaraSalvare(UploadedFile file, TipDocument tipo, Utilizator usuario) throws GesintException;

        /**
         * Eliminare de documente din baza de date. Documente care trebuie eliminat este primit ca parametru.
         * @param entity Documente pentru eliminare
         *
         */

        void delete(Documente entity);
        ...
        DefaultStreamedContent descarcareDocument(Documente entity) throws GesintException;
        ...
        List<Documente> findByFechaBajaIsNotNull();
        ...
        List<Documente> findByFechaBajaIsNull();
         ...
         */
        String obtieneNumeFisier(Documente document);
         ...
         * @param documento Documente care trebuie recuperat din coșul de gunoi
         */
        void recupereazaDocument(Documente document);
         ...
         * @return Documente Document salvat
         */

        Documente save(Documente entity);
